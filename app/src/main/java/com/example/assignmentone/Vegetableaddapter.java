...
public class Vegetableaddapter extends ArrayAdapter<Vegetable> {

    private Context mContext;
    private int mResource;
    public Vegetableaddapter (@NonNull Context context  , int Resourse , @NonNull ArrayList<Vegetable> object) {
    ...
    public View getView(int position, @NonNull View convertView, @NonNull ViewGroup parent) {
        ...
        Vegetable currentVegetable = getItem(position);
